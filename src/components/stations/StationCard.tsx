  ...
  return (
    <>
      ...
      >
        ...
        <motion.div 
          className="absolute inset-0 opacity-0 bg-gradient-radial from-ev-blue/20 to-transparent rounded-2xl"
          style={{
            x,
            y,
            scale: 1.5,
      ...
      <Dialog open={showBookingDialog} onOpenChange={setShowBookingDialog}>
        <DialogContent className="bg-gradient-to-br from-black/80 to-black/95 border-ev-blue/30 text-white max-w-md w-[90vw] rounded-2xl shadow-neon-blue">
          <DialogHeader>
